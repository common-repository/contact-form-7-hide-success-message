...
= 1.1.4 =
Compitable with the Latest version of the Wordpress 4.5.2. (Date: 26 May, 2016)

= 1.1.3 =
Compitable with the Latest version of the Wordpress 4.4.2. (Date: 18 March, 2016)
...
= 1.1.4 =
* Compitable upto 4.5.2.If you found any bug or want any help, go to our [Support Page](https://wordpress.org/support/plugin/contact-form-7-hide-success-message)